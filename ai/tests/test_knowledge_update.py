...
from ai.src.knowledge_update import update_knowledge
...
class KnowledgeUpdateTests(Fixture):
    def test_unchanged_corpus_keeps_revision_and_reuses_vectors(self):
        ...
        with patch("ai.src.knowledge_update.QwenKnowledgeSystem", return_value=system):
    ...
    def test_no_key_updates_bm25_without_constructing_remote_client(self):
        ...
        with patch("ai.src.knowledge_update.QwenKnowledgeSystem") as remote:
