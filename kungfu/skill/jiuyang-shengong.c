...
mixed valid_damage(object ob, object me, int damage, object weapon)
{
    ...
    if ((int)me->query_skill("jiuyang-shengong", 1) < 150 || me->query_skill_mapped("parry") != "jiuyang-shengong" || me->query_skill_mapped("force") != "jiuyang-shengong" || me->query_skill_mapped("unarmed") != "jiuyang-shengong" || (int)me->query("neili") < 500 || ob->query_temp("weapon") || !living(me) || random(2) != 1)
        return;
...
mixed hit_ob(object me, object victim, int damage_bonus, int factor)
{
    ...
    if (damage_bonus < 150 || lvl < 150 || me->query("neili") < 300 || me->query_skill_mapped("force") != "jiuyang-shengong" || me->query_skill_mapped("unarmed") != "jiuyang-shengong" || me->query_skill_prepared("unarmed") != "jiuyang-shengong")
        return 0;
    ...
    if (damage_bonus / 5 > victim->query_con())
    {
        ...
        return random(2) ? HIR "只见$N" HIR "九阳内劲自体内迸发，真气随招式"
                         ...
                         HIR "$N" HIR "九阳神功的潜力发挥了出来，突然间$n" HIR "只感喉咙一甜，喷出一口鲜血！\n" NOR;
    }
}
