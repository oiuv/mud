...
mixed valid_damage(object ob, object me, int damage, object weapon) {
    ...
    if ((int)me->query_skill(
        "jiuyang-shengong",
        1
    ) < 150 || me->query_skill_mapped("parry") != "jiuyang-shengong" || me->query_skill_mapped("force") != "jiuyang-shengong" || me->query_skill_mapped("unarmed") != "jiuyang-shengong" || (int)me->query("neili") < 500 || ob->query_temp("weapon") || !living(me) || random(2) != 1)
        return;
