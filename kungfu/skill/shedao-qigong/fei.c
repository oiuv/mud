...
int perform(object me, object target) {
    ...
    switch (random(3)) {
        case 0:
            msg = HIY "$N" HIY "怪叫一声，手中的" + weapon->name() + HIY "一晃，化作数道光影飞向$n" HIY "！\n" NOR;
            break;

        case 1:
            msg = HIY "$N" HIY "口中念念有词，手中的" + weapon->name() + HIY "越使越快，渐渐形成一团光芒，笼罩了$n" HIY "！\n" NOR;
            break;

        default:
            msg = HIY "$N" HIY "怪笑两声，欺身近来，步法极其怪异，手中的" + weapon->name() + HIY "忽然击出，一连数招逼向$n" HIY "！\n" NOR;
            break;
    }
