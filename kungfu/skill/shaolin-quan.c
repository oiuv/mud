...
mapping *action = ({
([      "action": "只见$N飞身一纵，一招「撞钟势」凌空一拳打向$n的$l",
        "dodge": 15,
        "parry": 15,
        "attack": 20,
        "force": 120,
...
([      "action": "$N步履一沉，左拳拉开，右拳带风，一招「罗汉伏虎」势不可挡地击向$n$l",
        "dodge": 25,
        "parry": 25,
        "attack": 30,
        "force": 140,
...
([      "action": "只见$N拉开架式，一招「踏波行」使得虎虎有风。底下却飞起一脚踢向$n$l",
        "dodge": 20,
        "parry": 20,
        "attack": 25,
        "force": 160,
...
([      "action": "$N一个转身，左掌护胸，右掌使了个「闯少林」往$n当头一拳",
        "dodge": 30,
        "parry": 30,
        "attack": 40,
        "force": 140,
...
([      "action": "只见$N拉开架式，一招「折转东来」使得虎虎有风，数只手掌一齐击向$n的$l",
        "dodge": 20,
        "parry": 20,
        "attack": 25,
        "force": 160,
...
([      "action": "$N一个转身，左掌护胸，右掌使了个「偏花七星」往$n当头拂过",
        "dodge": 30,
        "parry": 30,
        "attack": 40,
        "force": 220,
...
int valid_learn(object me)
{
        ...
        if ((int)me->query_skill("unarmed", 1) < (int)me->query_skill("shaolin-quan", 1))
                return notify_fail("你的基本拳脚火候不足，无法领会更高深的少林长拳。\n");

        if ((int)me->query_skill("cuff", 1) < (int)me->query_skill("shaolin-quan", 1))
                return notify_fail("你的拳法根基火候不足，无法领会更高深的少林长拳。\n");
