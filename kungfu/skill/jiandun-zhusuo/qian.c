...
int perform(object me, object target) {
    ...
    msg = HIW "$N" HIW "一声轻哼，右手横挥，手中" + wname + HIW "一招「千头万绪」对准$n" HIW "乱点下来。\n" NOR;
    ...
    msg += "\n" HIW "却见$N" HIW "跨步上前，手中" + wname + HIW "招数一变，反转鞭鞘，抽向$n" HIW "而去。\n" NOR;
    if (ap / 2 + random(ap) > dp) {
        msg += COMBAT_D->do_damage(me, target, WEAPON_ATTACK, damage, 10,
    ...
    msg += "\n" HIW "紧接着又见$N" HIW "纵身而起，单手将" + wname + HIW "急速舞动，凌空朝着$n" HIW "圈去。\n" NOR;
    if (ap / 2 + random(ap) > dp) {
        msg += COMBAT_D->do_damage(me, target, WEAPON_ATTACK, damage, 10,
