...
mixed hit_ob(object me, object victim, int damage_bonus, int factor)
{
    ...
    if (lvl < 150 || me->query("neili") < 300 || !objectp(weapon = me->query_temp("weapon")) || random(me->query_skill("force") / 6) < victim->query_con() || random(3) > 1 || !me->query("can_learn/yunv-xinjing/wall"))
        return 0;
