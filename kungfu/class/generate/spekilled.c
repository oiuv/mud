...
void die(object killer) {
    object dob; /* 打晕这个NPC的人 */ int n; /* 可以奖励的人的数目 */ int exp; /* 需要瓜分的经验 */ int pot; /* 需要瓜分的潜能 */ int weiwang; /* 需要瓜分的威望 */ int score; /* 需要瓜分的阅历 */ int gongxian; /*  */ object *t; /* 杀死我的人的队伍列表 */ object tob;
    // int i;
