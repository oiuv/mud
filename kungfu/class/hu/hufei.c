...
mixed ask_baodao() {
    ...
    if (objectp(owner) && owner != this_object()) {
        ...
        if (owner->query("family/family_name") == "关外胡家")
            return "冷月宝刀现在暂时是你兄弟" + owner->query("name") + "在用，你要用就去找他吧。";
        else
            return "俺的冷月宝刀现在落在了" + owner->query("name") + "手中，你去把它找回来吧！";
    }
    ob->move(this_object());
...
mixed ask_jundao() {
    ...
    if (objectp(owner) && owner != this_object()) {
        ...
        if (owner->query("family/family_name") == "关外胡家")
            return "闯王军刀现在暂时是你兄弟" + owner->query("name") + "在用，你要用就去找他吧。";
        else
            return "俺的闯王军刀现在落在了" + owner->query("name") + "手中，你去把它找回来吧！";
    }
    ob->move(this_object());
...
mixed ask_quanjing() {
    ...
    if (objectp(owner) && owner != this_object()) {
        ...
        if (owner->query("family/family_name") == "关外胡家")
            return "胡家拳经现在暂时被你兄弟" + owner->query("name") + "取去看了，你要看就去找他吧。";
        else
            return "我们胡家的家传拳经现在落在了" + owner->query("name") + "手中，你去把它夺回来吧！";
    }
    ob->move(this_object());
...
mixed ask_daopu() {
    ...
    if (objectp(owner) && owner != this_object()) {
        ...
        if (owner->query("family/family_name") == "关外胡家")
            return "胡家刀谱现在暂时被你兄弟" + owner->query("name") + "取去看了，你要看就去找他吧。";
        else
            return "我们胡家的家传刀谱现在落在了" + owner->query("name") + "手中，你去把它夺回来吧！";
    }
    ob->move(this_object());
