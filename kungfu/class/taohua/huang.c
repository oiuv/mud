...
mixed ask_book1() {
    ...
    if (objectp(owner) && owner != this_object()) {
        ...
        if (owner->query("family/family_name") == "桃花岛")
            return "那书现在暂时是你同门" + owner->query("name") + "在看，你要用就去找他吧。";
        else
            return "桃花药理现在落在了" + owner->query("name") + "手中，你去找他索回吧。";
    }
    ob->move(this_object());
...
mixed ask_book2() {
    ...
    if (objectp(owner) && owner != this_object()) {
        ...
        if (owner->query("family/family_name") == "桃花岛")
            return "箫谱现在暂时是你同门" + owner->query("name") + "在看，你要用就去找他吧。";
        else
            return "老夫的箫谱现在落在了" + owner->query("name") + "手中，你去找他索回吧。";
    }
    ob->move(this_object());
...
mixed ask_book3() {
    ...
    if (objectp(owner) && owner != this_object()) {
        ...
        if (owner->query("family/family_name") == "桃花岛")
            return "扫叶腿法现在暂时是你同门" + owner->query("name") + "在看，你要用就去找他吧。";
        else
            return "旋风扫叶腿法现在落在了" + owner->query("name") + "手中，你去找他索回吧。";
    }
    ob->move(this_object());
...
mixed ask_yuxiao() {
    ...
    if (objectp(owner) && owner != this_object()) {
        ...
        if (owner->query("family/family_name") == "桃花岛")
            return "玉箫现在暂时是你同门" + owner->query("name") + "在用，你要用就去找他吧。";
        else
