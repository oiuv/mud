...
mixed ask_gou() {
    ...
    if (objectp(owner) && owner != this_object()) {
        ...
        if (owner->query("family/family_name") == "五毒教")
            return "金蜈钩现在暂时是你同门师兄弟" + owner->query("name") + "在用，你要用就去找他吧。";
        else
            return "本门的金蜈钩现在落在" + owner->query("name") + "手中，你去把它抢回来吧！";
    }
...
mixed ask_suo() {
    ...
    if (objectp(owner) && owner != this_object()) {
        ...
        if (owner->query("family/family_name") == "五毒教")
            return "软红蛛索现在暂时是你同门师兄弟" + owner->query("name") + "在用，你要用就去找他吧。";
        else
            return "本门的软红蛛索现在落在" + owner->query("name") + "手中，你去把它抢回来吧！";
    }
...
mixed ask_she() {
    ...
    if (objectp(owner) && owner != this_object()) {
        ...
        if (owner->query("family/family_name") == "五毒教")
            return "含沙射影现在暂时是你同门" + owner->query("name") + "在用，你要用就去找他吧。";
        else
            return "我的含沙射影现在落在" + owner->query("name") + "手中，你去把它抢回来吧！";
    }
    ob->move(this_object());
...
mixed ask_jing() {
    ...
    if (objectp(owner) && owner != this_object()) {
        ...
        if (owner->query("family/family_name") == "五毒教")
            return "毒经现在是你同门" + owner->query("name") + "在看，去找他吧。";
        else
            return "我教的毒经现落在" + owner->query("name") + "的手中，你去把它夺回来吧！";
    }
    ob->move(this_object());
