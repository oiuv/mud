...
LONG);
    ...
    int accept_ask(object me, string topic) {
        switch (topic) {
            case "历练": case "历炼": case "锻炼": return QUEST_D->accept_ask(this_object(), me, topic);
            break;

            case "连环剑术": return MASTER_D->teach_pfm(me, this_object(),
            ...
            case "风神诀": return MASTER_D->teach_pfm(me, this_object(),
            ...
            case "开天辟地": return MASTER_D->teach_pfm(me, this_object(),
