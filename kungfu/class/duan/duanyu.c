...
void help_girl(object me) {
    ...
    switch (me->query("gender")) {
        case "男性":
            msg = "这位" + RANK_D->query_respect(me) + "，你怎能如此狠心？这么动人的妹子你也下得了手？";
            break;
        case "女性":
            msg = "这位" + RANK_D->query_respect(me) + "，你莫非妒忌人家美貌，所以下此毒手？";
            break;
        default:
            msg = "这位" + RANK_D->query_respect(me) + "，我说你已然半男不女，怎么还打女孩子的主意？";
            break;
    }
    command("say " + msg);
