...
int cure_ob(object me) {
    ...
    if ((int)me->query_condition("bonze_drug") > 0 || (int)me->query_condition("mang_shedan") > 0) {
        me->add("eff_jingli", -1);
        me->add("max_jingli", -1);
        message_vision(HIR "$N吃下一颗蛇胆，只觉得头重脚轻，摇摇欲倒，原来服食太急太多，药效适得其反！\n" NOR, me);
    ...
    tell_object(
        me,
        MAG "你张口轻轻一咬，蛇胆外皮便即破裂，登觉满口苦汁，腥极苦极，几乎要呕将出来。\n" + "可稍过片刻，你只觉呼吸顺畅，耳清目明，精神爽利，力气大增。\n" NOR
    );
