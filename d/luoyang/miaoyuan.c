...
int do_peiyu()
{
    ...
    {
        tell_object(me, "你已经完成了培育这道程序，现在可以浇水" HIY "(jiaoshui)" NOR "。\n");
        return 1;
    }
...
int do_jiaoshui()
{
    ...
    {
        // 成功率
        if (random(10) < highest(random(me->query("mark/job_zhonghua")), 5))
        {
            // 记录种花成功次数
            ...
            tell_object(me, HIC "通过这次训练，你获得了" + chinese_number(exp) + "点经验和" + chinese_number(pot) + "点潜能。\n" NOR);
            return 1;
        }
