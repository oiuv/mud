...
string look_duilian()
{
    return HIR "\n"
        ...
        "             ※※      ※※            ※※      ※※\n"
        "             ※※" NOR +
        HIW "　行　" NOR + HIR "※※            ※※" NOR + HIW "  坐  " NOR + HIR "※※\n"
        "             ※※　 　 ※※            ※※      ※※\n"
        "             ※※" NOR +
        HIW "  到  " NOR + HIR "※※            ※※" NOR + HIW "  看  " NOR + HIR "※※\n"
        "             ※※      ※※            ※※      ※※\n"
        "             ※※" NOR +
        HIW "  水  " NOR + HIR "※※            ※※" NOR + HIW "  云  " NOR + HIR "※※\n"
        "             ※※      ※※            ※※      ※※\n"
        "             ※※" NOR +
        HIW "  穷  " NOR + HIR "※※            ※※" NOR + HIW "  起  " NOR + HIR "※※\n"
        "             ※※      ※※            ※※      ※※\n"
        "             ※※" NOR +
        HIW "  处  " NOR + HIR "※※            ※※" NOR + HIW "  时  " NOR + HIR "※※\n"
        "             ※※    　※※            ※※      ※※\n"
        "             ※※※※※※※            ※※※※※※※\n"
        "             ※※※※※※※            ※※※※※※※\n\n" NOR;
}
