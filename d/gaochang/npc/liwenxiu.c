...
void create()
{
    ...
    set_skill("dodge", 150);
    set_skill("parry", 150);
    set_skill("liuxing-chui", 150);
    set_skill("yan-fly", 150);
    map_skill("whip", "liuxing-chui");
    map_skill("parry", "liuxing-chui");
...
int ask_gaochang()
{
    ...
    else if (me->query_temp("marks/李2") && me->query("combat_exp") < 10000)
    {
        command("shake " + me->query("id"));
        command("say 你的江湖经验太浅，何必去惹事上身？");
        return 1;
    }
    else if (me->query_temp("marks/李2"))
    {
