...
mixed ask_mine()
{
    ...
    if (me->query("combat_exp") > 100000 && me->query("mark/job_mine1") > 1000)
...
mixed ask_transit()
{
    ...
    if (me->query("combat_exp") > 300000 && me->query("mark/job_transit1") > 1000)
