...
void lost()
{
    ...
    scorei = random(query("combat_exp") / 500) + 100;
    weiwangi = random(query("combat_exp") / 200) + 100;
    expi = random(NPC_D->check_level(this_object()) * 1000) + 5000;
    poti = random(5000) + 8000;
    ob->add("score", scorei);
