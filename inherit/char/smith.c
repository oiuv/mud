...
string ask_me() {
    ...
    switch (random(3)) {
        ...
        case 2:
            ...
            return "去帮我把这些刚出炉的淬(" HIY "cuihuo" NOR + CYN ")一下火。";
    }
}
...
int do_repair(string arg) {
    ...
    if (cost >= 100000) cost = ((cost - 100000) / 2 + 100000) / 10000 * 10000; else if (cost >= 10000) cost = cost / 1000 * 1000; else if (cost >= 1000) cost = cost / 100 * 100; else if (cost >= 100) cost = cost / 10 * 10;
