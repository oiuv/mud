...
varargs int do_channel(object me, string verb, string arg, int emote) {
    ...
    if (userp(me)) {
        ...
        switch (channels[verb]["only"]) {
            ...
            case "party":
                ...
                if (strlen(party) == 3) {
                    party = party[0..0] + " " + party[1..1] + " " + party[2..2];
                }
            ...
            case "family":
                ...
                if (strlen(family) == 3) {
                    family = family[0..0] + " " + family[1..1] + " " + family[2..2];
                }
    ...
    if (emote) {
        ...
        if (emote == 2 && !arg)
            arg = me->name(channels[verb]["name_raw"]) + ecol + "[" + me->query("id") + "@" + INTERMUD_MUD_NAME + "]" + arg + "\n";
        if (!stringp(arg))
            return 0;
