...
private void special_bonus(object me, object who, mixed arg)
{
        ...
        //if ((who->query("quest_count") == 400)&&(exp>=400000))
        {
        ...
        //if ((who->query("quest_count") == 300)&&(exp>=300000))
        {
        ...
        //if ((who->query("quest_count") == 200)&&(exp>=200000))
        {
...
/*
//师门杀人任务取消威望限制，有阅历杀人足矣，没听说没威望还不能杀人
                ...
                */
                ...
                } else
                {
                        ...
                        tell_object(who, CYN + me->name() + CYN "对你说道：我早就看"
                                         ...
                                         "，听说" + gender + "最近在" + place + "，你去做了"
                                         + gender + "，带" + gender + "的人头来交差！\n" NOR);
                }
