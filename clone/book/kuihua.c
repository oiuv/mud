...
int do_du(string arg) {
    ...
    if (plvl > 200) neili_lost = 140; else if (plvl > 170) neili_lost = 120; else if (plvl > 140) neili_lost = 100; else if (plvl > 120) neili_lost = 80; else if (plvl > 100) neili_lost = 60; else if (plvl > 80) neili_lost = 40; else if (plvl > 60) neili_lost = 30; else if (plvl > 50) neili_lost = 20; else
        neili_lost = 10;
