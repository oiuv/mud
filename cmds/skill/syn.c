...
int main(object me, string arg)
{
    ...
    message_sort(HIM "\n$N" HIM "长叹一声，凝视着自己心爱的" + item->name() + HIM "，只见一道白光闪过，$N" HIM "的鲜血已洒在" + item->name() + HIM "上，霎那间，天地失色，日月无光，鲜血慢慢地被" + item->name() + HIM "吸收。渐渐地，$N" HIM "已与其融合为一体！\n" NOR, me, item);
