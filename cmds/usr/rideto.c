    ...
    if (arg == "family")
    {
        ...
        else
        {
            if (me->query("family/family_name") == "少林派")
                ...
                room = get_object("/d/yanziwu/canheju");
            else if (me->query("family/family_name") == "欧阳世家")
                room = get_object("/d/baituo/dating");
            else if (me->query("family/family_name") == "玄冥谷")
                room = get_object("/d/xuanminggu/xuanmingfeng");
            else if (me->query("family/family_name") == "昆仑派")
                room = get_object("/d/kunlun/tieqinju");
            else if (me->query("family/family_name") == "逍遥派")
                room = get_object("/d/xiaoyao/qingcaop");
                ...
                room = get_object("/d/wudu/huating1");
            else if (me->query("family/family_name") == "桃花岛")
                room = get_object("/d/taohua/dating");
            else if (me->query("family/family_name") == "血刀门")
            ...
            else if (me->query("family/family_name") == "关外胡家")
                room = get_object("/d/guanwai/xiaowu");
            else if (me->query("family/family_name") == "全真教")
                room = get_object("/d/quanzhen/shiweishi");
            else if (me->query("family/family_name") == "中原苗家")
                room = get_object("/d/zhongzhou/miaojia_houting");
            else if (me->query("family/family_name") == "红花会")
                room = get_object("/d/kaifeng/hh_zhengting");
            else if (me->query("family/family_name") == "灵鹫宫")
                room = get_object("/d/lingjiu/dating");
            else if (me->query("family/family_name") == "华山派")
                room = get_object("/d/huashan/qunxianguan");
            else if (me->query("family/family_name") == "段氏皇族")
                room = get_object("/d/dali/neitang");
                ...
                if (me->query("family/family_name") == "绝情谷")
            {
                if (me->query("family/master_name") == "裘千尺")
                    ...
                    room = get_object("/d/jueqing/zizhuxuan");
            }
