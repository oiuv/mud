...
string *tough_level_desc = ({BLU "不堪一击" NOR,
                             BLU "毫不足虑" NOR,
                             BLU "不足挂齿" NOR,
                             BLU "初学乍练" NOR,
                             BLU "略知一二" NOR,
...
int look_room(object me, object env, int brief)
{
    ...
    if (mapp(exits = env->query("exits")))
    {
        ...
        if (sizeof(dirs) == 0)
            ...
            str += "{\"code\":20011,\"data\":{\"msg\":[\"" + mapexits[0..<4] + "\"]}}@@\n";
    }
    // 获取环境内容物
...
int look_living(object me, object obj)
{
    ...
    if (obj->is_character() && obj->query("can_speak"))
    {
        // 是人物角色
